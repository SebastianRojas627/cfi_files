...
import { RespuestaBusqueda, RespuestaSujeto } from './utils/types/types';
import { generatePDFBuffer } from 'src/pdf/generateBufferPdf';
...
export class FilesService {
  ...
  async generatePDF(respuesta: RespuestaBusqueda) {
    return generatePDFBuffer(respuesta);
  }
}
